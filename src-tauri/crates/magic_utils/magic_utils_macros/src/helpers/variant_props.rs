...
pub trait HasMagicVariantProperties {
    fn get_variant_properties(&self) -> syn::Result<MagicVariantProperties>;
}

#[derive(Clone, Eq, PartialEq, Debug, Default)]
pub struct MagicVariantProperties {
...
impl HasMagicVariantProperties for Variant {
    fn get_variant_properties(&self) -> syn::Result<MagicVariantProperties> {
        let mut output = MagicVariantProperties {
