...
use crate::helpers::{
    non_enum_error, occurrence_error, HasInnerVariantProperties, HasMagicVariantProperties,
    HasTypeProperties,
};
...
pub fn from_string_inner(ast: &DeriveInput) -> syn::Result<TokenStream> {
    ...
    let magic_module_path = type_properties.crate_module_path();

    let mut default_kw = None;
    let mut default =
        quote! { ::core::result::Result::Err(#magic_module_path::ParseError::VariantNotFound) };
    ...
    let phf_body = if phf_exact_match_arms.is_empty() {
        ...
        quote! {
            use #magic_module_path::_private_phf_reexport_for_macro_if_phf_feature as phf;
    ...
    let from_str = quote! {
        ...
        impl #impl_generics ::core::str::FromStr for #name #ty_generics #where_clause {
            type Err = #magic_module_path::ParseError;
