...
use serde::Serialize;
use tauri::{self, Manager, SystemTray, SystemTrayMenu, SystemTraySubmenu, CustomMenuItem, SystemTrayMenuItem, SystemTrayEvent, AppHandle, Wry, App};
...
pub fn create_tray(lang: &str, id: &str) -> SystemTray {
    ...
    SystemTray::new().with_menu(create_tray_menu(lang)).with_id(id)
}
