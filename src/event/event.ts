...
export const useModelEvent = <D extends Record<string, any>>(topic: string, label: string, handler: EventHandler<D>): void => {
...
export const useModelEvents = <D extends Record<string, any>>({topic, exclude, idAttribute, state, setState}: ModelEventsProps<D>): ModelEventsResult<D> => {
