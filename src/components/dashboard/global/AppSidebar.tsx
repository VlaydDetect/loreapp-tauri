			...
			<Sidebar collapsed={isCollapsed}>
				<Menu>
					...
					{!isCollapsed && (
						<Box mb="25px">
							<Box display="flex" justifyContent="center" alignItems="center">
								<img alt="profile-user" width="100px" height="100px" src={avatar} style={{ cursor: "pointer", borderRadius: "50%" }}/>
							</Box>
					...
					<Box paddingLeft={isCollapsed ? undefined : "10%"}>
						...
						<Item title="Settings" to="/settings" icon={<TuneOutlinedIcon />} selected={selected} setSelected={setSelected}/>
					</Box>
				</Menu>
			</Sidebar>
		</Box>
