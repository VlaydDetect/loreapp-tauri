...
const Picture = ({ picture, className }: { picture: IPicture, className: string }) => {
	...
	return (
		<div className="m-2">
			...
			>
				<img className="rounded-lg w-full" src={convertFileSrc(picture.imgPath)} alt="gallery-picture"/>
				{picHovered && (
