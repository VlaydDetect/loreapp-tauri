...
import {INSERT_IMAGE_COMMAND, InsertImageDialog} from './ImagePlugin';
...
function ComponentPickerMenuItem({index, isSelected, onClick, onMouseEnter, option}: IMenuItemProps) {
    let className = 'item';
    if (isSelected) {
        className += ' selected';
    }
