...
import catTypingGif from '../../../../public/cat-typing.gif';
...
import {InsertNewTableDialog, InsertTableDialog} from './TablePlugin/TablePlugin';
...
const ELEMENT_FORMAT_OPTIONS: { [key: string]: {icon: string; name: string} } = {
    center: {
        icon: 'center-align',
        name: 'Center Align',
    },
...
interface IFormatDropdownProps {
...
function ElementFormatDropdown({editor, value, isRTL, disabled = false}: IFormatDropdownProps) {
    return (
        <DropDown
            disabled={disabled}
...
function BlockFormatDropDown({editor, blockType, rootType, disabled = false}: IBlockFormatDropDownProps) {
...
function FontDropDown({editor, value, style, disabled = false,}: IFontDropDownProps) {
