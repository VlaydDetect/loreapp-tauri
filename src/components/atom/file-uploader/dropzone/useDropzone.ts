...
export type DropEvent = Event | React.DragEvent<HTMLElement> | React.ChangeEvent<HTMLElement>;
...
export function useDropzone({
    ...
    useEffect(() => {
        ...
        const onDocumentDragOver = (e: Pick<Event, 'preventDefault'>) => e.preventDefault();
