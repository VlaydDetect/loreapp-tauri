...
import GeographyChart from "../../components/dashboard/charts/GeographyChart";
    ...
    return (
        <Box m="20px">
            ...
            <Box display="grid" gridTemplateColumns="repeat(12, 1fr)" gridAutoRows="140px" gap="20px">
                ...
                {/*@ts-ignore*/}
                <Box gridColumn="span 3" backgroundColor={colors.primary[400]} display="flex" alignItems="center" justifyContent="center">
                    <StatBox title="1,325,134" subtitle="Traffic Unbound" progress="0.8" increase="+43%" icon={<TrafficIcon sx={{ color: colors.greenAccent[600], fontSize: "26px" }}/>} />
                </Box>
                ...
                <Box gridColumn="span 4" gridRow="span 2" backgroundColor={colors.primary[400]} overflow="auto">
                    ...
                    {mockTransactions.map((transaction, ndex) => (
                        <Box key={`${transaction.txId}-${ndex}`} display="flex" justifyContent="space-between" alignItems="center" borderBottom={`4px solid ${colors.primary[500]}`} p="15px">
                            <Box>
